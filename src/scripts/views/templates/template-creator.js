...
<img class="content-thumbnail-detail lazyload" src="${CONFIG.BASE_IMAGE_URL + restaurants.pictureId}" alt="${restaurants.name}" />
<h3>Information</h3>
...
<article class="content-item ${restaurants.Id}">
  <img class="content-thumbnail lazyload" src="${CONFIG.BASE_IMAGE_URL + restaurants.pictureId}" alt="${restaurants.name}">
